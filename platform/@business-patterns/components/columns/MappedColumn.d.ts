export function MappedColumn(): JSX.Element;
export namespace MappedColumn {
    function defaultCell(row: any, rowId: any, { path, visible, valueMap }: {
        path: any;
        visible: any;
        valueMap: any;
    }): any;
    ...
    const defaultProps: {
        valueMap: {};
        renderCell: (row: any, rowId: any, { path, visible, valueMap }: {
            path: any;
            visible: any;
            valueMap: any;
        }) => any;
