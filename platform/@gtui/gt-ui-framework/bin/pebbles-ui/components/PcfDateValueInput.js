...
exports.PcfDateValueInput = void 0;
...
class DateValueInput extends _PcfComponent.default {
  constructor(cssSelector) {
    for (var _len = arguments.length, options = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      options[_key - 1] = arguments[_key];
    }

    // This is exactly the same as GwTextInput, currently
  ...
  // Should probably add APIs for the date picker


}

var PcfDateValueInput = function pcfDateValueInputFactory(selector) {
  for (var _len2 = arguments.length, options = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
    options[_key2 - 1] = arguments[_key2];
  }

  return new DateValueInput(selector, ...options);
};

exports.PcfDateValueInput = PcfDateValueInput;