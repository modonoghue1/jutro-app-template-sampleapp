...
const { fakeDynamicImport } = require('enzyme-adapter-utils');
...
module.exports = function detectFiberTags() {
    ...
    const supportsProfiler =
        typeof React.unstable_Profiler !== 'undefined' ||
        typeof React.Profiler !== 'undefined';
    ...
    return {
        ...
        MemoClass: supportsMemo
            ...
            : -1,
        HostPortal: getFiber(
            ReactDOM.createPortal(null, global.document.createElement('div'))
        ).tag,
        ...
        ContextProvider: supportsContext
            ? getFiber(React.createElement(Ctx.Provider, { value: null }, null))
                  .tag
            : -1,
        ...
        Suspense: supportsSuspense
            ? getFiber(React.createElement(React.Suspense, { fallback: false }))
                  .tag
            : -1,
