 ...
 * @metadataType field
 */
export class TextAreaField extends FieldComponent<PropTypes.InferProps<{
    /**
     * The rows attribute specifies the visible height of a text area, in lines.
     */
    rows: PropTypes.Requireable<number>;
    /**
     * Restricts the max length of the text in the text area field
     */
    ...
    /**
     * Custom onKeyPress handler for `textarea` element. Allows to break line when pressing Alt/Option + Enter. Uses `notifyChange` to invoke onValueChange callback
     *
 ...
 * Renders a multi-line text area.
 */
export type TextAreaFieldPropTypes = typeof TextAreaField.propTypes;
